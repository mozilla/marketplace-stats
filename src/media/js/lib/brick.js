  ...
  doc.addEventListener('WebComponentsReady', function(){
    ...
    function I(a) {
        ...
        for (var b = [], c = 0; c < a.length; c++) {
            ...
            if (e(i) ? d = f = i : (d = i[0], f = i[1]), i = D(d, f) ? d : [
                    d,
                    f
                ], e(j))
                g = h = j;
            ...
            if (D(d, [j]) || D(C(d), [j])) {
                var k = g.valueOf() < d.valueOf() ? g : d, l = h.valueOf() > f.valueOf() ? h : f, m = D(k, l) ? k : [
                        k,
                        l
                    ];
                b[b.length - 1] = m
    ...
    function J(a, b) {
        ...
        l(b, S) ? (a.xtag.dragType = R, c = 'datetoggleoff') : (a.xtag.dragType = Q, c = 'datetoggleon'), a.xtag.dragStartEl = b, a.xtag.dragAllowTap = !0, a.noToggle || xtag.fireEvent(a, c, {
            detail: {
                date: e,
                iso: d
            }
        }), a.setAttribute('active', !0), b.setAttribute('active', !0)
    }
    function K(a, b) {
        var c = b.getAttribute('data-date'), d = t(c);
        b !== a.xtag.dragStartEl && (a.xtag.dragAllowTap = !1), a.noToggle || (a.xtag.dragType !== Q || l(b, S) ? a.xtag.dragType === R && l(b, S) && xtag.fireEvent(a, 'datetoggleoff', {
            detail: {
                date: d,
                iso: c
            }
        }) : xtag.fireEvent(a, 'datetoggleon', {
            detail: {
                date: d,
                iso: c
            }
        })), a.xtag.dragType && b.setAttribute('active', !0)
    }
    function L() {
    ...
    xtag.register('x-calendar', {
        lifecycle: {
            created: function () {
                ...
                this.xtag.calObj = new H({
                    span: this.getAttribute('span'),
                    view: t(this.getAttribute('view')),
                    chosen: u(a),
                    multiple: this.hasAttribute('multiple'),
                    firstWeekdayNum: this.getAttribute('first-weekday-num')
                }), b(this, this.xtag.calObj.el), this.xtag.calControls = null, this.xtag.dragType = null, this.xtag.dragStartEl = null, this.xtag.dragAllowTap = !1
            },
            inserted: function () {
    ...
    xtag.register('x-datepicker', {
        lifecycle: {
            created: function () {
                ...
                b.setAttribute('type', 'date'), xtag.addClass(b, 'x-datepicker-input'), this.appendChild(b), this.xtag.dateInput = b, this.xtag._labels = {
                    yearAbbr: 'Y',
                    monthAbbr: 'M',
                    dayAbbr: 'D'
                }, this.xtag._polyfillCalLabels = a(p), this.xtag.polyfillInput = null, this.xtag.polyfillUI = null, this.polyfill = this.hasAttribute('polyfill') || 'date' !== b.type.toLowerCase()
            }
        },
        events: {
            'datetoggleon:delegate(x-calendar)': function (a) {
                var b = a.currentTarget;
    ...
    m.pushState = function (a) {
        ...
        accessors: { transitionOverride: { attribute: { name: 'transition-override' } } },
        methods: {
            show: function () {
                var a = this.parentNode;
    ...
    xtag.register('x-iconbutton', {
        lifecycle: {
            ...
            inserted: function () {
                l || (l = {
                    tapend: xtag.addEvent(document, 'tapend', e),
                    dragend: xtag.addEvent(document, 'dragend', e),
                    keyup: xtag.addEvent(document, 'keyup', c)
                }), b(this), a(this)
            },
            removed: function () {
    ...
    xtag.register('x-layout', {
        ...
        accessors: {
            ...
            taphide: { attribute: { 'boolean': !0 } },
            hoverhide: { attribute: { 'boolean': !0 } },
            scrollhide: { attribute: { 'boolean': !0 } },
            maxcontent: {
                attribute: { 'boolean': !0 },
                set: function (b) {
                    var e = a(this);
    ...
    function a(a) {
        ...
        return [
            b ? xtag.query(a, 'x-slides > x-slide').indexOf(b) : b,
            a.firstElementChild.children.length - 1
        ]
    }
    function b(a, b) {
    ...
    function c(a) {
        ...
        if (c && c.children.length && 'x-slides' == c.tagName.toLowerCase()) {
            var e = xtag.toArray(c.children), f = 100 / (e.length || 1), g = this.getAttribute('orientation') || 'x', h = 'x' == g ? [
                    'width',
                    'height'
                ] : [
                    'height',
    ...
    xtag.register('x-slider', {
        ...
        events: {
            'change:delegate(input[type=range])': function (a) {
                a.stopPropagation(), xtag.fireEvent(a.currentTarget, 'change')
            },
        ...
        accessors: {
            ...
            max: {
                attribute: { selector: 'input[type=range]' },
                get: function () {
    ...
    function d(a, b) {
        return b = void 0 !== b ? b : c(a), {
            x: a.offsetWidth ? b.width / a.offsetWidth : 1,
            y: a.offsetHeight ? b.height / a.offsetHeight : 1
        }
    }
    function e(a, b) {
    ...
    function t(a, b, e, f, g) {
        ...
        var k = c(f);
        g = g ? g : d(f, k);
        var l = f.clientTop * g.y, m = f.clientLeft * g.x, o = f.scrollTop * g.y, p = f.scrollLeft * g.x, q = {
                left: h - k.left - m,
                top: i - k.top - l
            };
    ...
    function y(b, c) {
        ...
        for (var g in G)
            d.setAttribute(J, G[g]), e = z(b, c, g), e && (w(b), q(b, c) || f.push({
                orient: g,
                rect: e
            }), x(b));
        var h = v(b, f);
    ...
    function z(e, f, g, h) {
        ...
        var O = u(e, l), P = O.left, Q = O.top, R = O.right - E, S = O.bottom - F, T = {
                left: v.left + (A - E) / 2,
                top: v.top + (B - F) / 2
            }, U = T.left, V = T.top;
        if ('top' === g)
        ...
        x(e);
        var mb = 2;
        return mb > h && (E !== ib || F !== jb || p !== kb || q !== lb) ? z(e, f, g, h + 1) : {
            left: W,
            top: X,
            width: ib,
            height: jb,
    ...
    var E, F, G = {
            ...
            left: 'right',
            right: 'left'
        }, H = '_previousSibling', I = '_nextSibling', J = 'arrow-direction', K = '_auto-orientation';
